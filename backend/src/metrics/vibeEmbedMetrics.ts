...
/** Active-space coverage values exposed by the worker process. */
...
/** Registers bounded audio-embedding job and active-space coverage metrics. */
export function createVibeEmbedMetrics(registry: Registry): VibeEmbedMetrics {
    ...
    const coverage = new Gauge({
        ...
        help: "Local-track vibe embedding coverage for the active space.",
