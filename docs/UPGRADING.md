...
| ---------------- | -------------- |
| **2.6.1** | None — plain rolling update; no database migrations. Fixes the Last.fm connect flow's error reporting and makes every documented optional environment variable settable on Compose/AIO deployments. |
