...
test("TidalFeaturedShelvesSection renders home + explore shelves", async () => {
    const { TidalFeaturedShelvesSection } =
        await import("../../features/explore/components/TidalFeaturedShelvesSection");
                    ...
                    contents: [
                        {
                            ...
                            playlistId: "abc",
                            title: "Playlist A",
                            thumbnailUrl: "http://img.test/a.jpg",
                        },
                    ],
                },
            ],
                    ...
                    contents: [
                        {
                            ...
                            title: "P",
                            thumbnailUrl:
                                "https://resources.tidal.com/images/abc/123x123.jpg",
                        },
                    ],
                },
            ],
...
test("TidalFeaturedShelvesSection hides Shortcuts shelf from homeShelves", async () => {
    ...
    assert.doesNotMatch(
        html,
        /Shortcut Playlist/,
        "Shortcuts shelf content is hidden",
    );
...
test("TidalFeaturedShelvesSection hides Shortcuts shelf from exploreShelves (case-insensitive)", async () => {
    ...
    assert.doesNotMatch(
        html,
        /Explore Shortcut/,
        "Shortcuts content from exploreShelves is hidden",
    );
