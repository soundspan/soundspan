...
export function WithPodcasts<TBase extends ApiClientConstructor>(Base: TBase) {
    abstract class PodcastsApi extends Base {
        ...
        async getPodcast(id: string) {
            return this.request<ApiData>(`/podcasts/${id}`, {
                silent404: true,
            });
        }
        ...
        async deletePodcastEpisodeProgress(
            podcastId: string,
            episodeId: string,
        ) {
            return this.request<ApiData>(
        ...
        async getPodcastsByGenrePaginated(
            genreId: number,
            limit = 20,
            offset = 0,
        ) {
        ...
        async subscribePodcast(feedUrl: string, itunesId?: string) {
            return this.request<{ success: boolean; podcast?: ApiData }>(
                "/podcasts/subscribe",
                {
                    method: "POST",
