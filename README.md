...
- Release notes template and generator: [`.agents-config/docs/RELEASE_NOTES_TEMPLATE.md`](.agents-config/docs/RELEASE_NOTES_TEMPLATE.md) (`npm run release:notes -- --version <X.Y.Z> --from <tag> [--to <ref>] [--output <path>]`)
