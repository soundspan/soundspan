...
| --- | --- | --- |
| `library-and-home` | `npm --prefix backend test -- --runInBand src/routes/__tests__/libraryRuntime.test.ts src/routes/__tests__/homepageRuntime.test.ts`<br>`npm --prefix frontend run test:component`<br>`npm --prefix frontend run test:unit` | `backend/src/routes/__tests__/libraryRuntime.test.ts`<br>`backend/src/routes/__tests__/homepageRuntime.test.ts`<br>`frontend/tests/component/trackPreferenceButtons.component.test.ts`<br>`frontend/tests/component/explorePage.component.test.ts`<br>`frontend/tests/component/exploreMadeForYouSection.component.test.ts`<br>`frontend/tests/component/exploreFeaturedShelvesSection.component.test.ts`<br>`frontend/tests/component/exploreMoodsGenresTab.component.test.ts`<br>`frontend/tests/unit/exploreGenreClassification.test.ts`<br>`frontend/tests/unit/exploreNavigation.test.ts` |
