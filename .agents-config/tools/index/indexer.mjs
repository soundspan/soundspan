...
const DEFAULT_CONFIG_PATH = ".agents-config/tools/index/index.config.json";
...
Usage:
  node .agents-config/tools/index/indexer.mjs build [--full] [--config <path>] [--output <dir>]
  node .agents-config/tools/index/indexer.mjs query "<text>" [--top <n>] [--json] [--strict-fresh] [--verify] [--output <dir>]
  node .agents-config/tools/index/indexer.mjs verify [--strict] [--config <path>] [--output <dir>] [--json]
...
function queryIndex(args) {
  ...
  if (!queryText) {
    fail("Missing query text. Example: node .agents-config/tools/index/indexer.mjs query \"playback state route\"");
  }
