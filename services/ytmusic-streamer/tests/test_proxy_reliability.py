...
class FakeUpstream:
    ...
    def __init__(self, headers: Any, chunks: Any, status_code: Any = 206) -> None:
    ...
    async def aiter_bytes(self, chunk_size: Any = 65536) -> Any:
...
class FakeClient:
    ...
    def __init__(self, upstream: Any = None, raise_on_send: Any = False) -> None:
        self._up = upstream
        self.raise_on_send = raise_on_send
        self.closed = False

    def build_request(self, method: Any, url: Any, headers: Any = None) -> Any:
        return (method, url, headers)

    async def send(self, request: Any, stream: Any = False) -> Any:
        if self.raise_on_send:
            raise RuntimeError("send boom")
        return self._up

    def stream(self, method: Any, url: Any, headers: Any = None) -> Any:
        return self._up
...
def _patch_stream_info(monkeypatch: pytest.MonkeyPatch, app: Any) -> Any:
...
def _patch_client_factory(
    monkeypatch: pytest.MonkeyPatch, app: Any, fake_client: FakeClient
) -> Any:
...
@pytest.mark.anyio
async def test_range_response_omits_content_length(
...
@pytest.mark.anyio
async def test_range_send_failure_closes_client_no_leak(
    client: AsyncClient, monkeypatch: pytest.MonkeyPatch
) -> None:
    import app
...
@pytest.mark.anyio
async def test_full_response_streams_and_closes(
    client: AsyncClient, monkeypatch: pytest.MonkeyPatch
) -> None:
    import app
